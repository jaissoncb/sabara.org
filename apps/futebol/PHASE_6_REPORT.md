...
- Testes específicos: `pnpm exec vitest run src/draw/adjustments.test.ts src/draw/DrawPanel.test.tsx` — 12/12 PASS.
- Lint: `pnpm lint` — PASS, zero warnings.
- Typecheck: `pnpm typecheck` — PASS.
- Suíte frontend completa: `pnpm test` — 83/83 PASS em nove arquivos.
