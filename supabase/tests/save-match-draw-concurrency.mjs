...
try {
  ...
  await query(`BEGIN;
    ...
    INSERT INTO public.groups (id, name, created_by) VALUES ('${group}', 'Concurrency fixture', '${actor}');
  ...
  try {
    await query(`BEGIN;
      DELETE FROM public.matches WHERE group_id = '${group}' AND created_by = '${actor}';
      DELETE FROM public.groups WHERE id = '${group}' AND created_by = '${actor}';
